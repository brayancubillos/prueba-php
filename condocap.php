...
<br><br><br>
          <table class="table display AllDataTables">
                    ...
                    <?php
					$log = mysqli_query($con,"SELECT * FROM doc_ap WHERE  num_doc = ".$_SESSION["num_doc"]);
                ...
                <tr>
			      ...
			      <td >
				  <center>
                       <a href="elidocap.php?nom_doc=<?php echo $docs['nom_doc']; ?>" class="btn btn-sm btn-danger">&nbsp&nbsp&nbspEliminar</a>
					   </center>
                   </td>
