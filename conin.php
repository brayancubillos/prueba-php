    ...
    <body>
      ...
      <br><br><br><br>
        ...
        <div class="container">
              <br><br>
              <section id="info">
        <span class="label datos">Grupo de seguimiento</span>
        <div class="contenedor">
          <div class="info-grupo">
            <img src="images/ins1.jpg"/>
            <h4><span class="label datos">Instructor 1</span></h4>
      	  <h4><span class="label datos">Telefono</span></h4>
          </div>
          <div class="info-grupo">
            <img src="images/liderseg.jpg"/>
            <h4><span class="label datos">Alba Isabel Lopez Rubiano</span></h4>
      	  <h4><span class="label datos">314 4218266 - 319 2785444</span></h4>
          </div>
          <div class="info-grupo">
            <img src="images/in3.png"/>
            <h4><span class="label datos">Instructor 3</span></h4>
      	  <h4><span class="label datos">Telefono</span></h4>
          </div>
        </div>
