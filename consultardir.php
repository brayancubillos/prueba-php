...
<br><br>
        ...
        <table align="center" border="1"   class="table table-striped">
                    ...
                    <thead>
                  <tr>
                   <th style="width:5px;">ID</th><th style="width:5px;">NOMBRE</th><th style="width:5px;">APELLIDOS</th><th style="width:5px;">TIPO DE DOCUMENTO</th><th style="width:5px;">NUMERO DE DOCUMENTO</th><th style="width:5px;">CORREO</th><th style="width:5px;">CELULAR</th><th style="width:5px;">DIRECCION</th><th style="width:5px;">GENERO</th><th style="width:5px;">OPERACIONES</th>
                </tr>
              </thead>

              <?php
                  foreach ($listaDeUsuarios as $directivo){
              ?>
              <tr>
                 <td><?php echo $directivo->id;?>
			        </td>
              <td><?php echo $directivo->nombre_dir;?>
              </td>
                  <td><?php echo $directivo->apellidos_dir;?>
            </td>
              <td><?php echo $directivo->tipo_doc_dir;?>
            </td>
        <td><?php echo $directivo->num_doc?>
            </td>
                  <td><?php echo $directivo->correo_dir;?>
            </td>
            <td><?php echo $directivo->celular_dir;?>
            </td>
              <td><?php echo $directivo->direccion_dir;?>
            </td>
         <td><?php echo $directivo->genero_dir;?>
            </td>

          <td >

                     <a href="editar_dir.php?id=<?php echo $directivo->id;?>" class="btn btn-primary">&nbspEditar&nbsp&nbsp&nbsp&nbsp</a>
                     <a href="eliminar_dir.php?id=<?php echo $directivo->id;?>" class="btn btn-sm btn-danger">&nbsp&nbsp&nbspEliminar&nbsp&nbsp</a>
                  ...
                  ?>
				  <a target="_blank" href="pdfdir.php?id=<?php echo $directivo->id;?>" class="btn btn-sm btn-info">DESCARGAR EN PDF</a>&nbsp
                <a href="registro_Directivo.php" class="btn btn-success">Registrar</a>
