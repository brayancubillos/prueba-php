...
<br><br>
        ...
        <table align="center" border="1"   class="table table-striped">
              ...
              <?php
                  foreach ($listaDeUsuarios as $gruposeg){
              ?>
              <tr>
              <td><?php echo $gruposeg->id;?>
            </td>
              <td><?php echo $gruposeg->nombre_gs;?>
            </td>
                  <td><?php echo $gruposeg->apellido_gs;?>
            </td>
              <td><?php echo $gruposeg->tipo_doc_gs;?>
            </td>
        <td><?php echo $gruposeg->num_doc?>
            </td>
                  <td><?php echo $gruposeg->correo_gs;?>
            </td>
            <td><?php echo $gruposeg->celular_gs;?>
            </td>
              <td><?php echo $gruposeg->direccion_gs;?>
            </td>
         <td><?php echo $gruposeg->genero_gs;?>
            </td>

          <td >

                     <a href="editar_gs.php?id=<?php echo $gruposeg->id;?>" class="btn btn-primary">&nbspEditar&nbsp&nbsp&nbsp&nbsp</a>
                     <a href="eliminar_gs.php?id=<?php echo $gruposeg->id;?>" class="btn btn-sm btn-danger">&nbsp&nbsp&nbspEliminar&nbsp&nbsp</a>
                  ...
                  ?>
				  <a target="_blank" href="pdfinst.php?id=<?php echo $gruposeg->id;?>" class="btn btn-sm btn-info">DESCARGAR EN PDF</a>&nbsp
                <a href="registro_instructor.php" class="btn btn-success">Registrar</a>
