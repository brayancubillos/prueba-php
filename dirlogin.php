...
<body>
<br><br><br>
  <form id="formulariodir" action="sesiondir.php" align=center style="box-shadow: 10px 10px 5px grey;" method="post">
          <img src="img/directivos.png" align=center height="150px" width="150px" style="border-radius: 15px;">
  <br><br>
    <span class="label directivo">Usuario</span>
          <div class="form-input clearfix">
            <br>
          <input type="text" name="numdocu" id="documento" size="15"  placeholder="Documento de Identidad" style="border-top-right-radius: 20px;" required>
          </div>
          ...
          <input type="submit" id="loginbtn" class="btn btn-block bg_blue" style="width: 100%; border-radius: 5px; font-size: 23px; padding: 5px 0; background-color: #0A534A; margin: 10px 0; box-shadow: 0 5px #0A534A;" name="btndir" value="Ingresar"><br></a>
