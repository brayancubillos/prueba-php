...
require 'conexion.php';
    ...
    $num_doc = (isset($_GET['num_doc'])) ? $_GET['num_doc'] : 0;
        ...
        $db = new MyDatabase();
        $query = "SELECT * FROM peliculas WHERE num_doc = :num_doc ;";
        $params = array(
            ':num_doc' => $num_doc
        );

        $peliculas = $db->row($query, $params);
	          ...
	          <div class="col-md-9">
                 <div class="well">
                     <form action="editarusu.php" method="POST">
                         <div class="form-group">
                             ...
                             <input type="text" class="form-control" name="nombre"  value="<?php echo $peliculas->nombre;?>"/>
                         </div>
						 <div class="form-group">
                         <select size="1" class="form-control" id="genero" name="genero" required>
								<option>Genero</option>
                                <option><?php echo $peliculas->genero;?></option>
			   ...
			   <div class="container">
			     <div class="col-md-4 ">
				   ...
				   <center>
			         <div class="form-group">
                          <input type="hidden" name="idusuario" value="<?php echo $peliculas->num_doc;?>" />
                          <div class="form-group">
							  <br>
                              <button type="submit" class="btn btn-primary">Guardar</button>
								                              &nbsp&nbsp&nbsp
                              <a href="admaprend.php" class="btn btn-danger">Cancelar</a>
                          </div>
					 </div>
					 </center>
				  </div>
