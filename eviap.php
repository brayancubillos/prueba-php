    ...
    <header>
      <img src="img/banner.PNG" align=center height="170px" width="100%" >
        ...
        <div class="column" style="background-color: #238279">
          ...
          <div class="dropdown">
            <button class="dropbtn"onclick="window.location.href = 'alternativasgs.php';">Alternativas</button>
            <div class="dropdown-content">
            </div>
          </div>
	  ...
	  <div class="col-md-3 ">
		...
		<ul class="acorh">
           ...
           <table class="table display AllDataTables">
			      ...
			      <td >
                       <center>
                       <a href="eliminardocap.php?nom_doc=<?php echo $docs['nom_doc'];?>" class="btn btn-sm btn-danger">&nbsp&nbsp&nbspEliminar</a>
					   </center>
                   </td>
